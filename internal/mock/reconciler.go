...
//
//	mockgen -package mock --copyright_file hack/boilerplate.go.txt --destination internal/mock/reconciler.go sigs.k8s.io/controller-runtime/pkg/reconcile Reconciler
//
