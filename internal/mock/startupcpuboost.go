...
import (
	...
	policy "github.com/google/kube-startup-cpu-boost/internal/boost/policy"
...
// BoostPercent mocks base method.
func (m *MockStartupCPUBoost) BoostPercent() int64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BoostPercent")
	ret0, _ := ret[0].(int64)
	return ret0
}

// BoostPercent indicates an expected call of BoostPercent.
func (mr *MockStartupCPUBoostMockRecorder) BoostPercent() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BoostPercent", reflect.TypeOf((*MockStartupCPUBoost)(nil).BoostPercent))
}
...
func (m *MockStartupCPUBoost) DurationPolicies() map[string]policy.DurationPolicy {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DurationPolicies")
	ret0, _ := ret[0].(map[string]policy.DurationPolicy)
	return ret0
}
