...
func (in *BoostTrigger) DeepCopyInto(out *BoostTrigger) {
	*out = *in
	...
	if in.FromStatus != nil {
		in, out := &in.FromStatus, &out.FromStatus
		*out = new(string)
		**out = **in
	}
	if in.ToStatus != nil {
		in, out := &in.ToStatus, &out.ToStatus
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BoostTrigger.
func (in *BoostTrigger) DeepCopy() *BoostTrigger {
	if in == nil {
		return nil
	}
	out := new(BoostTrigger)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CooldownPolicy) DeepCopyInto(out *CooldownPolicy) {
	*out = *in
	if in.MinIntervalSeconds != nil {
		in, out := &in.MinIntervalSeconds, &out.MinIntervalSeconds
		*out = new(int32)
		**out = **in
	}
	if in.MaxActivationsPerHour != nil {
		in, out := &in.MaxActivationsPerHour, &out.MaxActivationsPerHour
		*out = new(int32)
		**out = **in
	}
}
